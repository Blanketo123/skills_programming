...
# Load models
model_with_weather = load_model("Blanketo123/skills_programming/Model/finalized_model_with_weather.sav")
model_without_weather = load_model("Blanketo123/skills_programming/Model/finalized_model_without_weather.sav")
